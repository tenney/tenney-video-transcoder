...
class FFMPEGExecutor {
    ...
    private Logger logger = Logger.getLogger(FFMPEGExecutor.class);
	/**
	...
	public void execute() throws IOException {
		...
		StringBuilder sbCommond = new StringBuilder();
		cmd[0] = ffmpegExecutablePath;
		for (int i = 0; i < argsSize; i++) {
			cmd[i + 1] = args.get(i);
			sbCommond.append(args.get(i)).append(" ");
		}
		logger.info("执行转码:" + sbCommond.toString());
